...
/**
 * Classe ApiCommande qui implémente l'interface CommandeAccessInterface.
 * Cette classe gère l'accès aux commandes d'un utilisateur via une API externe.
 */
class ApiCommande implements CommandeAccessInterface
{
    ...
    public function getCommandesByUserId($userId): array
    {
        ...
        $apiUrl = "https://exemple-api.com/commandes?userId={$userId}"; // Remplacer par l'URL réelle de l'API
